# Generated by Django 3.2.3 on 2024-07-21 19:33
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=150, unique=True, validators=[recipes.validators.validate_username], verbose_name='Псевдоним пользователя')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cooking_time', models.IntegerField(validators=[django.core.validators.MinValueValidator(limit_value=1)], verbose_name='Время приготовления в минутах')),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='recipes', to=settings.AUTH_USER_MODEL, verbose_name='Автор')),
                ('ingredients', models.ManyToManyField(related_name='recipes', through='recipes.AmountReceptIngredients', to='recipes.Ingredient', verbose_name='Продукты')),
            ],
            options={
                'verbose_name': 'Рецепт',
        ...
        migrations.AddField(
            ...
            name='ingredient',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='amount_ingredients', to='recipes.ingredient', verbose_name='Продукт'),
        ),
        migrations.AddField(
            model_name='amountreceptingredients',
            name='recipe',
        ...
        migrations.AddConstraint(
            model_name='subscription',
            constraint=models.CheckConstraint(check=models.Q(('author', django.db.models.expressions.F('user')), _negated=True), name='No_self_sibscription'),
        ),
        migrations.AddConstraint(
            model_name='shoppingcart',
            constraint=models.UniqueConstraint(fields=('user', 'recipe'), name="{'app_label': 'recipes', 'class': 'shoppingcart'}ecipes_unique"),
        ),
        migrations.AddConstraint(
            model_name='favorite',
            constraint=models.UniqueConstraint(fields=('user', 'recipe'), name="{'app_label': 'recipes', 'class': 'favorite'}ecipes_unique"),
        ),
        migrations.AddConstraint(
            model_name='amountreceptingredients',
